...
class bus_booking:
    ...
    def cover_page(self):
        ...
        Label(root, text="\n\nName: PRIYANSH SAXENA", font='Arial 16 bold', fg='blue').pack()
        Label(root, text="\nEnrollment No. : 221B280", font='Arial 16 bold', fg='blue').pack()
            ...
            if tp.isalpha() and fp.isalpha():
                if not jd=='':
                    ...
                    if len(res_route)==0:
                        ...
                        cur.execute('select bus_id from bus where route_id=?', (res_route[0]))
                        ...
                        if len(res_bid)==0:
                            ...
                            if len(b)==0:
                                ...
                                for i in b:
                                    bus_no=i
                                    cur.execute('Select op_id from bus where bus_id=?',(bus_no))
